...
int main() {
    ...
    // 2
    std::cout << Task2::aggregate(vector, Task2::add) << std::endl;
    std::cout << Task2::aggregate(vector, Task2::mul) << std::endl;

    // 3
    std::cout << Task3::aggregate(vector, Task3::mul, 10) << std::endl;
    std::cout << Task3::aggregate(vector, Task3::concat, std::string("0")) << std::endl;
